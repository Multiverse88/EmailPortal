...
- Halaman & Fitur Utama Portal:
  ...
  2. Legal Drive (/documents): Manajemen berkas hukum klien (Akta Perusahaan, Perizinan, Perpajakan, Kontrak/Perjanjian). Penyimpanan berbasis Cloud S3 IDCloudHost (Hot Storage 5 GB). Berkas berumur > 90 hari diarsipkan ke Cold Storage Synology NAS. Fitur: pratinjau, unduh, unggah dokumen, dan klasifikasi otomatis kategori folder — jika pengguna meminta merapikan/mengklasifikasikan berkas, sertakan quick action { label: '🧹 Rapikan Sekarang', action: 'tidy-documents' }.
