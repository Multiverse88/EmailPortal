...
const INBOX_EMAILS = [
  {
    ...
    bodyText: 'Halo Budi Setiawan, invoice perpanjangan izin usaha dan sewa virtual office periode 2026-2027 sebesar Rp 4.500.000 telah terbit. Jatuh tempo: 15 September 2026.',
    bodyHtml: `
  ...
  },
  {
    ...
    bodyText: 'Yth. Bapak Budi Setiawan, akta notaris perubahan anggaran dasar dan dokumen perjanjian kerjasama telah selesai ditandatangani dengan e-Meterai Peruri.',
    bodyHtml: `
  ...
  },
  {
    ...
    bodyText: 'Selamat! Surat Keputusan Menteri Hukum dan HAM atas pendirian dan pengesahan badan hukum PT Maju Bersama Digital telah resmi terbit.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
  ...
  },
  {
    ...
    bodyText: 'Terlampir laporan rekonsiliasi PPh 21, PPh 23, dan PPN untuk periode Juli - September 2026. Semua status kewajiban pajak dilaporkan nihil denda.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
  ...
  },
  {
    ...
    bodyText: 'Selamat pagi Pak Budi, apakah jadwal meeting evaluasi kemitraan hari Senin jam 10.00 WIB tetap diadakan via Zoom? Mohon konfirmasinya.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
  ...
  },
  {
    ...
    bodyText: 'Pemberitahuan otomatis: Domain clienteasylegal.co.id aktif hingga Mei 2027. Kuota mailbox saat ini 0.2% dari 100 akun.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
  ...
  },
  {
    ...
    bodyText: 'Terlampir hasil scan dokumen perizinan NIB berbasis risiko dan NPWP cabang yang sudah disahkan dinas terkait.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
        <p>Halo Pak Budi,</p>
  ...
  },
  {
    ...
    bodyText: 'Selamat siang Pak Budi, kami dari tim penasihat investasi ingin mendiskusikan mekanisme RUPS untuk peningkatan modal disetor seri A.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
  ...
  },
  {
    ...
    bodyText: 'Tiket support Anda #EL-9042 perihal sinkronisasi domain mail clienteasylegal.co.id telah berhasil diselesaikan oleh tim teknis.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
  ...
  },
  {
    ...
    bodyText: 'Edisi September 2026: Poin-poin penting ketentuan PKWT, kompensasi pemutusan kerja, dan standarisasi kepatuhan BPJS Ketenagakerjaan bagi startup.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
  ...
  },
  {
    ...
    bodyText: 'Panitia tender telah menerima berkas prakualifikasi teknis dari PT Maju Bersama Digital untuk paket pengadaan sistem manajemen arsip elektronik.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
  ...
  },
  {
    ...
    bodyText: 'Selamat datang di portal email khusus klien EasyLegal. Mailbox Anda telah aktif dan siap digunakan untuk komunikasi resmi perusahaan.',
    bodyHtml: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 640px;">
...
const SENT_EMAILS = [
  {
    ...
    bodyText: 'Halo Bu Rara, terima kasih konfirmasinya. Jadwal Senin jam 10.00 WIB sangat cocok bagi tim kami. Silakan kirimkan link Google Meet ke email ini.',
    bodyHtml: '<p>Halo Bu Rara,</p><p>Terima kasih atas konfirmasinya. Jadwal <strong>Senin jam 10.00 WIB</strong> sangat cocok bagi kami. Silakan kirimkan link Google Meet ke email ini, kami akan hadir bersama tim teknis.</p><br/><p>Salam,<br/><strong>Budi Setiawan</strong></p>',
    hoursAgo: 16,
  },
  {
    subject: 'Konfirmasi Pembayaran Invoice #INV-2026-088',
    recipients: 'billing@easylegal.co.id',
    bodyText: 'Selamat siang Tim Billing EasyLegal, bersama ini kami lampirkan bukti transfer pelunasan tagihan invoice #INV-2026-088 sebesar Rp 4.500.000 via BCA. Mohon dicek.',
    bodyHtml: '<p>Selamat siang Tim Billing EasyLegal,</p><p>Bersama ini kami lampirkan bukti transfer pembayaran lunas untuk invoice <strong>#INV-2026-088</strong> sebesar <strong>Rp 4.500.000</strong> via transfer m-Banking BCA.</p><p>Mohon konfirmasi jika dana sudah masuk dan kwitansi resmi telah diterbitkan. Terima kasih.</p><br/><p>Salam hormat,<br/><strong>Budi Setiawan</strong><br/>PT Maju Bersama Digital</p>',
    hoursAgo: 8,
    attachment: {
  ...
  },
  {
    ...
    bodyText: 'Yth. Notaris Ahmad Fauzi, berikut kami kirimkan revisi klausul pasal 7 terkait kerahasiaan data pengguna untuk ditinjau.',
    bodyHtml: '<p>Yth. Bapak Notaris Ahmad Fauzi, S.H.,</p><p>Berikut kami kirimkan penyesuaian draf pasal 7 mengenai perlindungan data pribadi dan masa retensi dokumen rahasia sesuai masukan tim kepatuhan kami.</p><br/><p>Hormat kami,<br/><strong>Budi Setiawan</strong></p>',
    hoursAgo: 28,
  },
  {
    subject: 'Data KTP & NPWP Direksi untuk Pengurusan OSS',
    recipients: 'perizinan@easylegal.co.id',
    bodyText: 'Halo Tim Perizinan, data identitas KTP dan NPWP seluruh jajaran direksi PT Maju Bersama Digital telah kami kumpulkan dan verifikasi validitasnya.',
    bodyHtml: '<p>Halo Tim Perizinan EasyLegal,</p><p>Seluruh berkas identitas direksi dan komisaris untuk keperluan integrasi NIB OSS telah siap diproses.</p><br/><p>Salam,<br/><strong>Budi Setiawan</strong></p>',
    hoursAgo: 50,
  },
];
...
const DRAFT_EMAILS = [
  {
    ...
    bodyText: 'Dengan hormat, sehubungan dengan keputusan RUPS tanggal 1 September mengenai pengunduran diri komisaris...',
    bodyHtml: '<p>Dengan hormat,</p><p>Sehubungan dengan hasil keputusan RUPS Luar Biasa tertanggal 1 September mengenai perubahan susunan dewan komisaris...</p>',
    hoursAgo: 5,
  },
  {
    subject: '[Draf] Permohonan Keringanan Biaya Konsultasi Hukum Retainer',
    recipients: 'finance@easylegal.co.id',
    bodyText: 'Selamat pagi rekan-rekan finance, kami ingin menanyakan apakah ada skema pembayaran multi-tahap untuk retainer tahunan...',
    bodyHtml: '<p>Selamat pagi Tim Finance EasyLegal,</p><p>Kami ingin menanyakan terkait program kemitraan tahun kedua...</p>',
    hoursAgo: 20,
  },
];
...
const TRASH_EMAILS = [
  {
    ...
    bodyText: 'Dapatkan diskon spesial akhir tahun untuk sewa ruang meeting di kawasan SCBD Sudirman.',
    bodyHtml: '<p>Dapatkan diskon 40% pemesanan ruang rapat representatif di pusat bisnis Jakarta.</p>',
    hoursAgo: 140,
  },
  {
    subject: 'Katalog Alat Tulis Kantor & Kebutuhan Printing Q4',
    sender: 'sales@stationery-murah.co.id',
    bodyText: 'Penawaran suplai kertas HVS dan toner printer kantor dengan harga distributor langsung.',
    bodyHtml: '<p>Katalog perlengkapan kantor triwulan 4 siap diantar gratis ongkir se-Jabodetabek.</p>',
    hoursAgo: 160,
  },
  {
    subject: 'Undangan Survei Evaluasi Kepuasan Vendor 2026',
    sender: 'survey@research-market.id',
    bodyText: 'Mohon luangkan waktu 3 menit untuk mengisi kuesioner evaluasi layanan vendor rekanan.',
    bodyHtml: '<p>Survei tahunan kepuasan mitra bisnis. Masukan Anda sangat berharga bagi kami.</p>',
    hoursAgo: 180,
  },
];
...
export async function seedDemoData() {
  console.log('🌱 Menyiapkan database dengan Data Dummy Lengkap untuk evaluasi UI...');
  ...
  // 2. Buat Beberapa Customer Mailbox
  ...
  for (const c of CUSTOMERS_DATA) {
    const cust = await prisma.customer.create({
      data: {
        ...
        status: c.status,
        lastLoginAt: c.lastLoginMinutesAgo ? new Date(Date.now() - c.lastLoginMinutesAgo * 60 * 1000) : null,
      },
    });
  ...
  // 3. Masukkan Email INBOX untuk Budi
  let uidCounter = 2000;
  ...
  // 4. Masukkan Email SENT untuk Budi
  ...
  // 5. Masukkan Email DRAFT untuk Budi
  ...
  // 6. Masukkan Email TRASH untuk Budi
  ...
  // 7. Masukkan Audit Logs untuk Admin Dashboard
  const auditEntries = [
    { action: 'mailbox.create', target: 'budi', daysAgo: 7, details: { mailboxAddress: `budi@${domain}`, initiatedBy: 'Admin Utama' } },
    { action: 'mailbox.create', target: 'siti', daysAgo: 6, details: { mailboxAddress: `siti@${domain}` } },
    { action: 'mailbox.create', target: 'hendra', daysAgo: 5, details: { mailboxAddress: `hendra@${domain}` } },
    { action: 'mailbox.deactivate', target: 'siti', daysAgo: 4, details: { mailboxAddress: `siti@${domain}`, reason: 'Permintaan penangguhan sementara' } },
    { action: 'mailbox.create', target: 'dewi', daysAgo: 3, details: { mailboxAddress: `dewi@${domain}` } },
    { action: 'mailbox.create', target: 'ahmad', daysAgo: 2, details: { mailboxAddress: `ahmad@${domain}` } },
    { action: 'mailbox.password_reset', target: 'budi', daysAgo: 1, details: { mailboxAddress: `budi@${domain}`, method: 'temporary_password' } },
    { action: 'mailbox.deactivate', target: 'maya', daysAgo: 0.2, details: { mailboxAddress: `maya@${domain}`, reason: 'Proses verifikasi dokumen tertunda' } },
  ];
  ...
  console.log(`  - URL         : http://localhost:3000/login (pilih tab Admin)`);
  console.log(`  - Email       : admin@${domain}`);
  console.log(`  - Password    : Admin123!`);
  console.log(`  - Total Mailbox: ${CUSTOMERS_DATA.length} customer (6 aktif, 2 nonaktif)`);
  console.log(`  - Audit Logs  : 8 entri riwayat aktivitas admin\n`);
  console.log(`Akun Customer Demo (Budi Setiawan - PT Maju Bersama Digital):`);
  console.log(`  - URL         : http://localhost:3000/login (pilih tab Customer)`);
  console.log(`  - Email       : budi@${domain}`);
  console.log(`  - Password    : Customer123!`);
  console.log(`  - Folder Kotak Masuk (Inbox)  : ${INBOX_EMAILS.length} email (5 belum dibaca, 2 berbintang)`);
  console.log(`  - Folder Terkirim (Sent)      : ${SENT_EMAILS.length} email (termasuk bukti transfer)`);
  console.log(`  - Folder Draf (Drafts)        : ${DRAFT_EMAILS.length} draf`);
  console.log(`  - Folder Sampah (Trash)       : ${TRASH_EMAILS.length} email promosi`);
